                            ...
                            <div class="col-12 p-0 align-self-center">
                                <div class="row">
                                    <div class="col-12 p-0 pb-3">
                                        <h2>سجل الدخول</h2>
                                        <p>أو قم بأنشاء حساب <a href="{{ route('register') }}" class="primary-color" style="color:#ffb400">من هنا</a></p>
                                    </div>
                                </div>
                                <div class="row" dir="rtl">
                                    <div class="col-12 p-0 input-group">
                                        <input type="email" placeholder="البريد الإلكتروني" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                    @error('email')
                            ...
                            <div class="col-12 align-self-center" align="center">
                                ...
                                <ul class="navbar-nav social share-list">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <a href="{{ route('social.login', 'google') }}" class="nav-link"><i class="icon-social-google"></i></a>
                    ...
                    <div class="modal-body">
                      ...
                      <form  action="{{ route('login')  }}" method="POST" id="loginForm" >
                            ...
                            <div class="col-12 p-0 align-self-center">
                                ...
                                <div  id="user-reg-email-err-msg"  class="alert alert-danger col-12 p-0 input-group"  id="denger" style="height: 20px;display:none">
                                    </div>
                                    
                                 <div class="row" dir="rtl">
                              
                                    <div class="col-12 p-0 input-group">
                                        <input type="email" id="emailModel"class="form-control @error('email') is-invalid @enderror" placeholder="البريد الإلكتروني" required>
                                    </div>
                                  
                                    <div class="col-12 p-0 input-group">
                                        <input type="password"  id="passwordModel" placeholder="كلمة المرور"  class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                                    
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 p-0 input-group align-self-center">
                                        <button  id="pp_form"class="btn primary-button"><i class="icon-login"></i>دخول</button>
                                    </div>
                                </div>
                            </div>
                        </form>
        ...
        <div id="register" class="p-0 modal fade" role="dialog" aria-labelledby="register" aria-hidden="true" align="right">
            <div class="modal-dialog modal-dialog-slideout" role="document">
                <div class="modal-content full">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('register') }}" method="POST" id="registerForm" class="row">
                            <div class="col-12 p-0 align-self-center">
                                <div class="row">
                                    <div class="col-12 p-0 pb-3">
                                ...
                                <div class="row" dir="rtl">
                                    <div class="col-12 p-0 input-group">
                                        <input type="text" class="form-control" id="usernameModel" placeholder="اسم المستخدم" required>
                                    </div>
                                    <div class="col-12 p-0 input-group">
                                        <input type="email" class="form-control" id="emailModelr"placeholder="البريد الإلكتروني" required>
                                    </div>
                                    <div class="col-12 p-0 input-group">
                                        <input type="password" class="form-control" id="passwordModelr" placeholder="كلمة المرور" required>
                                    </div>
                                    <div class="col-12 p-0 input-group">
                                        <input type="password" class="form-control" id="confirmpasswordModel" placeholder="اعد ادخال  كلمة المرور" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 p-0 input-group align-self-center">
                                        <button class="btn primary-button">أنشاء</button>
                                    </div>
                                </div>
                            </div>
                        </form>
...
//         'email':$('#emailModelr').val(),
//         'password':$('#passwordModelr').val(),
//         'confirmpasswordModel':$('#confirmpasswordModel').val()
//     }
