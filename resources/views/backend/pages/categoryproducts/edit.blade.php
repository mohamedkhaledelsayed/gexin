        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                <div class="card-header" style="background-color: #b78306;">
                    <h3 class="card-title">CategoriesProduct</h3>
                </div>

                <form action="{{ route('categoriesproductpage.update',$categoryproduct->id) }} " method="POST" enctype="multipart/form-data">
                 @csrf
                 @method('PUT')
                    <div class="card-body">
                        <div class="form-group">
                            <div class="form-group has-feedback col-xs-6 col-md-6 col-lg-6 {{ $errors->has('title') ? 'has-error' : '' }}">
                                <label>Title :</label>
                                <input type="text" name="title" class="form-control" value="{{ old('title',$categoryproduct->title) }}"> @if ($errors->has('title'))
                        ...
                        <div class="form-group">
                            <div class="form-group has-feedback col-xs-6 col-md-12 col-lg-12 {{ $errors->has('description') ? 'has-error' : '' }}">
                                ...
                                <textarea name="description" rows="5" cols="50" style="width:60%" value="{{old('description')}}">{{$categoryproduct->description}}</textarea> @if ($errors->has('description'))
                                <span class="alert alert-danger">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group has-feedback col-xs-4 col-md-4 col-lg-4 {{ $errors->has('image') ? 'has-error' : '' }}" ">
                              ...
                              @if($categoryproduct->image)
                                  <img src="../../uploads/categoryproducts/{{ ($categoryproduct->image) }}" class="img-thumbnail img-upload" id="blah" style="width: 280px"> @else
                            ...
                            @if($categoryproduct->bannerimage)
                            <img src="../../uploads/categoryproducts/{{ $categoryproduct->bannerimage }}" class="img-thumbnail img-upload" id="blahB" style="width: 280px">
                            @else
                        ...
                        <div class="form-group" style="margin-left:5px; ">
                            ...
                            <div class="custom-control custom-radio">
                                <input class="custom-control-input" type="radio" value="1" {{  ($categoryproduct->showhomepage == 1 ? ' checked' : '') }} id="customRadio3" onclick="gfg_Run()" name="showhomepage">
