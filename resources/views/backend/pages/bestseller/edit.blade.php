    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form action="{{ route('bestseller.update',$bestseller->id) }} " method="POST" enctype="multipart/form-data">
                 @csrf
                 @method('PUT')
              <div class="card-body">
            ...
            <label>link :</label>
            <input type="text" name="link" class="form-control" value="{{ old('link',$bestseller->link) }}" >
            @if ($errors->has('link'))
        ...
        <div class="form-group has-feedback col-xs-4 col-md-4 col-lg-4 {{ $errors->has('image') ? 'has-error' : '' }}"">
          ...
          <img src="../../uploads/bestseller/{{$bestseller->image}}" class="img-thumbnail img-upload" id="blah" style="width: 250px">
      
          <br><br>
          <div class="input-group">
            <span class="input-group-btn">
                <span class="btn btn-default btn-file" style="background-color: #06A8F0 ;color:#fff;">
                    Upload Image<input type="file" class="imgInp btn-file" name="image" id="imgInp" value="{{old('image', $bestseller->description)}}">
                </span>
            </span>
          </div>
