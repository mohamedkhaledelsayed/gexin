...
<div class="content-wrapper">
  ...
  <form method="post" action="{{ route('paymentgatewaypage.store') }}" enctype="multipart/form-data" >
  {!! csrf_field() !!}
  <div class="card-body">
  <div class="form-group">
        ...
        <div class="form-group has-feedback col-xs-4 col-md-4 col-lg-4 {{ $errors->has('image') ? 'has-error' : '' }}"">
          ...
          @if($paymentgateway && !$paymentgateway->image)
          ...
          <div class="form-group has-feedback col-xs-4 col-md-4 col-lg-4 {{ $errors->has('bannerimage') ? 'has-error' : '' }}"">
            ...
            @if($paymentgateway &&  !$paymentgateway->bannerimage )
                <img src="uploads/latestnews/{{ $paymentgateway->bannerimage }}" class="img-thumbnail img-upload" id="blahB" style="width: 280px">
            @else
