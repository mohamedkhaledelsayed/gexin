...
<div class="content-wrapper">
  ...
  <form method="post" action="{{ route('videopage.store') }}" enctype="multipart/form-data" >
  {!! csrf_field() !!}
  <div class="card-body">
        ...
        <label style="font-weight: 800 ">Cover Video  homeimage	</label> 
          @if($video && !$video->homeimage)
        <img src="uploads/video/{{ ($video->homeimage) }}" class="img-thumbnail img-upload" id="blah" style="width: 280px"> @else
        ...
        <div class="form-group has-feedback col-xs-4 col-md-4 col-lg-4 {{ $errors->has('image') ? 'has-error' : '' }}"">
          ...
          <label style="font-weight: 800" >All Videos Image: </label>


          @if($video && !$video->image)
              <img src="uploads/video/{{ ($video->image) }}" class="img-thumbnail img-upload" id="blaho" style="width: 280px">
          @else
          ...
          <div class="form-group has-feedback col-xs-4 col-md-4 col-lg-4 {{ $errors->has('bannerimage') ? 'has-error' : '' }}"">
                ...
                <label style="font-weight: 800" >Banner Image: </label>
                  ...
                  @if($video && !$video->bannerimage)
                    <img src="uploads/videos/{{ $video->bannerimage }}" class="img-thumbnail img-upload" id="blahB" style="width: 280px">
                  @else
        ...
        <div class="form-group" style="margin-left:5px; ">
            ...
            <div class="custom-control custom-radio">
                <input class="custom-control-input" type="radio" value="1" id="customRadio1" name="showhomepage">
