  ...
  <div class="card-body">
        ...
        <div class="form-group has-feedback col-xs-4 col-md-4 col-lg-4 {{ $errors->has('image') ? 'has-error' : '' }}"">
          ...
          <div class="form-group has-feedback col-xs-4 col-md-4 col-lg-4 {{ $errors->has('bannerimage') ? 'has-error' : '' }}"">
                    ...
                    @if($video && $video->bannerimage)
                      <img src="../../uploads/video/{{ $video->bannerimage }}" class="img-thumbnail img-upload" id="blahB" style="width: 280px">
                    @else
        ...
        <div class="form-group" style="margin-left:5px; ">
            ...
            <div class="custom-control custom-radio">
                <input class="custom-control-input" type="radio" value="1" id="customRadio1" name="showhomepage"  {{ $video->showhomepage == '1' ? 'checked' : '' }}>
