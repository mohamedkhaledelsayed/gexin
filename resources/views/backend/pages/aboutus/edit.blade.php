...
<div class="content-wrapper">
  ...
  <div class="card-body">
        ...
        <div class="form-group has-feedback col-xs-6 col-md-12 col-lg-12 {{ $errors->has('description') ? 'has-error' : '' }}">
            ...
            <textarea name="description" id="contant" rows="5" cols="50" style="width:60%" value="{{old('description') }}">{{ $aboutus->description}}</textarea>            
        ...
        <div class="form-group">
          ...
          <label style="font-weight: 800" >Banner Image: </label>
              ...
              @if($aboutus &&  $aboutus->bannerimage )
                  <img src="../../uploads/aboutus/{{ $aboutus->bannerimage }}" class="img-thumbnail img-upload" id="blahB" style="width: 280px">
              @else
