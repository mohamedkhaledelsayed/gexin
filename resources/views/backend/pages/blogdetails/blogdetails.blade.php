...
<div class="content-wrapper">
  ...
  <form method="post" action="{{ route('blogdetailspage.store') }}" enctype="multipart/form-data" >
  {!! csrf_field() !!}
  <div class="card-body">
        ...
        <div class="form-group has-feedback col-xs-4 col-md-4 col-lg-4 {{ $errors->has('image') ? 'has-error' : '' }}"">
          ...
          @if($blogdetails && $blogdetails->image)
              <img src="uploads/blogdetails/{{ $blogdetails->image }}" class="img-thumbnail img-upload" id="blah" style="width: 280px">
          @else
