 ...
 <div class="content-wrapper">
      ...
      <div class="row">
        <div class="col-12">
          ...
          @endif
            ...
            <button style="margin-right:10px;background-color: #b78306;border: none;" type="button" class="btn btn-info"><a href="{{url('backend/gamepage')}}" style="color:#fff;background-color: #b78306;text-decoration:none" >New Game  <i class="fa fa-plus-circle"></i></a></button>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <td>
                  <div style="width: 100px">
                   <a href="{{ route('game.edit',$game->id) }}" class="btn btn-s btn-success"><i class="fa fa-pen"></i></a>
                    @csrf
                   <button class="btn btn-s btn-danger" data-gameid="{{$game->id}}" data-toggle="modal" data-target="#deletegame"><i class="fa fa-trash"></i></button>
                  </div>
               </td> 
                </tr>
                @endforeach
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{  route('game.destroy','test') }}" method="post">
               @csrf
               @method('DELETE')
