...
<div class="content-wrapper">
  ...
  <form method="post" action="{{ route('gamepage.store') }}" enctype="multipart/form-data" >
  {!! csrf_field() !!}
  <div class="card-body">
        ...
        <div class="form-group">
              <div class="form-group has-feedback col-xs-6 col-md-6 col-lg-6 {{ $errors->has('title') ? 'has-error' : '' }}">
                  ...
                  @foreach($categories as $category)  
                     <option value="{{ $category->id }}" @if (old("category")){{ (in_array($category->id, old("category")) ? "selected":"") }}@endif>{{ $category->title }}</option>
                  @endforeach   
                   </select>
        ...
        <div class="form-group">
              <div class="form-group has-feedback col-xs-6 col-md-12 col-lg-12 {{ $errors->has('termsconditions') ? 'has-error' : '' }}">
                  ...
                  <textarea name="termsconditions" rows="5" cols="50" style="width:60%" value="{{old('termsconditions')}}"></textarea> 
        ...
        <div class="form-group" style="margin-left:5px; ">
            ...
            <div class="custom-control custom-radio">
                <input class="custom-control-input" type="radio" value="1" id="customRadio1" name="bestseller" {{ old('bestseller') == '1' ? 'checked' : '' }} >
