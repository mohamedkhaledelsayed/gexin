    ...
    <div class="content-header">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <form action="{{ route('categoriespage.update',$category->id) }} " method="POST" enctype="multipart/form-data">
                 @csrf
                 @method('PUT')
                    <div class="card-body">
                        <div class="form-group">
                            <div class="form-group has-feedback col-xs-6 col-md-6 col-lg-6 {{ $errors->has('title') ? 'has-error' : '' }}">
                                <label>Title :</label>
                                <input type="text" name="title" class="form-control" value="{{ old('title',$category->title) }}"> @if ($errors->has('title'))
                    ...
                    <strong>{{ $errors->first('title') }}</strong>
                            ...
                            <div class="form-group">
                                <div class="form-group has-feedback col-xs-6 col-md-6 col-lg-6 {{ $errors->has('title') ? 'has-error' : '' }}">
                                    ...
                                    <select name="designs" class="form-control">
                                        <option value="1" {{ $category->designs == 1 ? 'selected' : '' }}>design 1</option>
                                        <option value="2" {{ $category->designs == 2 ? 'selected' : '' }}>design 2</option>
                                        <option value="3" {{ $category->designs == 3 ? 'selected' : '' }}>design 3</option>
                            ...
                            <div class="form-group has-feedback col-xs-6 col-md-12 col-lg-12 {{ $errors->has('description') ? 'has-error' : '' }}">
                                ...
                                <textarea name="description" rows="5" cols="50" style="width:60%" value="{{old('description')}}">{{$category->description}}</textarea> @if ($errors->has('description'))
                        ...
                        <div class="form-group" style="margin-left:5px; ">
                            ...
                            <div class="custom-control custom-radio">
                                <input class="custom-control-input" type="radio" value="1" {{  ($category->showabovehome == 1 ? ' checked' : '') }} id="customRadio1" name="showabovehome">
                        ...
                        <div class="form-group" style="margin-left:5px; ">
                            ...
                            <div class="custom-control custom-radio">
                                <input class="custom-control-input" type="radio" value="1" {{  ($category->statusshowhome == 1 ? ' checked' : '') }} id="customRadio3" name="statusshowhome">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <label style="font-weight: 800 ">category homeimage	:  Size(400*226)</label> 
                                    <img src="../../uploads/category/{{ ($category->homeimage) }}" class="img-thumbnail img-upload" id="blah" style="width: 280px">
                                    <br><br>
                                ...
                                <div class="col-3">
                                    <label style="font-weight: 800 ">category iconimage: Size(70*68) </label> 
                                    <img src="../../uploads/category/{{ ($category->iconimage) }}" class="img-thumbnail img-upload" id="blaho" style="width: 280px"> 
                                    <br><br>
                                    <div class="input-group">
                                        <span class="input-group-btn">
                                          <span class="btn btn-default btn-file" style="background-color: #06A8F0 ;color:#fff;">
                                              Upload Image<input type="file" class="imgInp btn-file" name="iconimage" id="imgInpo" value="{{ old('image') }}">
                                          </span>
                                        </span>
                                    </div>
                                ...
                                <div class="col-3">
                                    <label style="font-weight: 800 ">category coverimage: Size(1200*322)</label> 
                                    <img src="../../uploads/category/{{ ($category->coverimage) }}" class="img-thumbnail img-upload" id="blahc" style="width: 280px"> 
                                    <br><br>
                                    <div class="input-group">
                                        <span class="input-group-btn">
                                          <span class="btn btn-default btn-file" style="background-color: #06A8F0 ;color:#fff;">
